    ...
    <DefaultLayout>
      <section>
        ...
        <div className="px-4 py-2">
          <div>
            <h1 className="font-bold text-4xl">Webinar Series</h1>
          </div>
          ...
          <div>
            ...
            <p className="text-justify text-lg">
              ...
              voluptatem commodi consectetur exercitationem repellat quibusdam
              nisi, eos quos atque repudiandae sequi fuga repellendus omnis?
              Culpa obcaecati debitis architecto qui corporis.
            </p>
          </div>
        </div>
      </section>
